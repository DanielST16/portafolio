    ...
    <div class="container mx-auto p-4">
        ...
        <form action="/posts" method="POST" class="bg-white p-6 rounded shadow-md">
            ...
            <div class="mb-4">
                ...
                <textarea id="content" name="content" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
            </div>
